...
public class ContainsAll {
	public static void main(String[] args) {
		...
		if(nums1.containsAll(nums2)) {
			...
			System.out.println("Nums do not containsAll nums2");
		}
		...
		// check if both have the same values
		if (planB.containsAll(planA) && planA.containsAll(planB)){
			System.out.println("Plans A and plans B match");
		}else {
			System.out.println("Plans A and plans B do not match");
		}
